module.exports = {
  ...
  DEV_APP_URL: process.env.DEV_APP_URL || 'https://local.topcoder-dev.com',
  CHALLENGE_API_URL: process.env.CHALLENGE_API_URL || 'https://api.topcoder-dev.com/v4',
  SUBMISSION_REVIEW_API_URL: process.env.SUBMISSION_REVIEW_API_URL || 'https://local.topcoder-dev.com:3010'
}
